       ...
       .subscribe((data)=>{
           ...
           this.restApi.getActivoXCodigo(codigo).subscribe((res)=>{
            ...
            if (json.data[0]==null){
              ...
              this.restApi.setActivo(codigo,nombre,descripcion,photoHash,precio_compre,tiempo_garantia,vida_util,depreciacion,fecha_compra,FechaR,centro_costo,valor_residual,categoria,moneda,1).subscribe((res)=>{});; 
